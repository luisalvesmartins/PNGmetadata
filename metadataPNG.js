...
metadataPNG.PNG_SIG = String.fromCharCode(0x89, 0x50, 0x4e, 0x47, 0x0d, 0x0a, 0x1a, 0x0a);

// check PNG signature
metadataPNG.isPNG = function (s) {
...
metadataPNG.splitChunk= function (s) {
  // read signature
  var sig = s.substr(0, 8);
  if (!metadataPNG.isPNG(sig)) return false;
...
metadataPNG.joinChunk = function (chunklist) {
  var pf = metadataPNG.PNG_SIG;
...
metadataPNG.createChunk = function (type, data) {
  var c = {};
  c.type = type;
  c.data = data;
  c.size = data.length;
